...
function LoginScreen({ onLogin }: { onLogin: () => void }) {
  ...
  const handleLogin = () => {
    setLoading(true);
    setTimeout(() => {
      const senhaCorreta = import.meta.env.VITE_APP_PASSWORD || 'jcv2026';
      if (senha === senhaCorreta) {
        localStorage.setItem('jcv-auth', 'true');
        onLogin();
      } else {
        setErro(true);
        setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-10 w-full max-w-sm flex flex-col items-center gap-6">
        <div className="flex flex-col items-center gap-2">
          <div className="font-bold text-blue-600 text-3xl tracking-tight">JCV<span className="text-slate-400 font-medium">contract</span></div>
          <p className="text-slate-400 text-sm">Sistema de Geração de Contratos</p>
        </div>
        <div className="w-full space-y-3">
          <div className="space-y-1">
            <label className="text-[8.5pt] font-bold text-slate-500 uppercase tracking-wider">Senha de acesso</label>
            <input
              type="password"
              value={senha}
              ...
              className={`w-full px-4 py-3 border rounded-xl text-sm outline-none transition-all ${erro ? 'border-red-400 bg-red-50 focus:border-red-500' : 'border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-50'}`}
            />
            {erro && <p className="text-red-500 text-[10pt]">Senha incorreta. Tente novamente.</p>}
          </div>
          <button
            onClick={handleLogin}
            disabled={loading || !senha}
            className="w-full py-3 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 disabled:opacity-40 transition-all"
          >
            {loading ? 'Verificando...' : 'Entrar'}
          </button>
        </div>
        <p className="text-[9pt] text-slate-300">JCV Academy LTDA © 2026</p>
      </div>
    </div>
  );
}
...
export default function App() {
  const [autenticado, setAutenticado] = React.useState(() => {
    return localStorage.getItem('jcv-auth') === 'true';
  });
  ...
  const ContractPreview = ({ isPrint = false, refToUse = null }: { isPrint?: boolean, refToUse?: React.RefObject<HTMLDivElement | null> | null }) => (
    <div
      ref={refToUse}
      style={{position:"relative"}} className={`bg-white w-full ${isPrint ? 'max-w-none' : 'max-w-[210mm] shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-doc-border min-h-[297mm]'} p-[10mm] md:p-[20mm] text-[11pt] leading-snug text-doc-text font-serif print:shadow-none print:border-none print:p-0 ${isPrint ? '' : 'mx-auto'}`}
    >

      <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%) rotate(-30deg)",opacity:0.05,pointerEvents:"none",zIndex:0,width:"65%"}}>
        <img src="data:image/png;base64," style={{width:"100%",filter:"grayscale(100%)"}} alt="" />
      </div>
